...
class ProjectsInitial: UIViewController {
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("ProjectsMain") as UIViewController
