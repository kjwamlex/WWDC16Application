...
class DevicesInitial: UIViewController {
...
UIApplication.sharedApplication().setStatusBarStyle(UIStatusBarStyle.Default, animated: true)
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("Devices1") as UIViewController
