...
class EducationIntial: UIViewController {
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("Education") as UIViewController
