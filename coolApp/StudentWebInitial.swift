//
//  StudentWebInitial.swift
//  coolApp
//
//  Created by Joonwoo Kim on 2016. 4. 27..
//  Copyright © 2016년 김준우. All rights reserved.
//

import UIKit

class StudentWebInitial: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        timer = NSTimer.scheduledTimerWithTimeInterval(1, target:self, selector: #selector(EducationIntial.finished), userInfo: nil, repeats: true)
    }
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("StudentWeb") as UIViewController
