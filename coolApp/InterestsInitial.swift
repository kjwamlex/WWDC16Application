...
class InterestsInitial: UIViewController {
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("Interests") as UIViewController
