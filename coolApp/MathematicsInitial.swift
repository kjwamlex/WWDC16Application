...
class MathematicsInitial: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        timer = NSTimer.scheduledTimerWithTimeInterval(1.0, target:self, selector: #selector(AppleDeviceiPadInitialViewController.finished), userInfo:
            nil, repeats: true)
    }
    ...
    func finished() {
        ...
        if counter == 1 {
            ...
            let vc : UIViewController = mainStoryboard.instantiateViewControllerWithIdentifier("Mathematics") as UIViewController
